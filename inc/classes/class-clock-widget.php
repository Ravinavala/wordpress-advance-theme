...
class Clock_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
                ...
                'Clock', // Name
                ['description' => __('Clock Widget', 'advance-theme'),] // Args
        );
    }
    ...
    public function form($instance) {
        if (isset($instance['title'])) {
            ...
            $title = __('Clock', 'advance-theme');
        }
        ?>
        <p>
            <label for="<?php echo $this->get_field_name('title'); ?>"><?php _e('Title:', 'advance-theme'); ?></label>

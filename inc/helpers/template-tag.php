 ...
 */
function the_post_custom_thumbnail($post_id, $size = 'featured-custom-thumbnail', $additional_attributes = []) {
    echo get_the_post_custom_thumbnail($post_id, $size, $additional_attributes);
}
function advance_theme_posted_on() {
    ...
    $posted_on = sprintf(
            esc_html_x("Posted on %s", 'post date', 'advance-theme'),
